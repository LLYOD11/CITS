...
def seed_data():
    ...
    users = [
        ...
        User(name="Alex Rivera", email="alex@company.com", tier=Tier.T1, role="SDM", avatar_initials="AR", efficiency_score=87.0,
        ...
        User(name="Priya Patel", email="priya@company.com", tier=Tier.T1, role="Junior SDM", avatar_initials="PP", efficiency_score=82.0,
        ...
        User(name="David Kim", email="david@company.com", tier=Tier.T3, role="Engineering Lead", avatar_initials="DK", efficiency_score=95.0,
